...
def main ():
    ...
    initial_epochs =2  #the number of iterations 
    ...
    cp_callback = tf.keras.callbacks.ModelCheckpoint(checkpoint_path,        # Tells our callback where to put each checkpoint per iteration/epoch
                                                    monitor='vs_d',          # Tells the callback to monitor a parameter in the model.
    ...
    plt.savefig('vgg16_loss_accuracy_graph')                  #Saves our graphs
